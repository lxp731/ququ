...
class WindowManager {
  ...
  async createMainWindow() {
    ...
    if (isDev) {
      ...
      await this.mainWindow.loadFile(path.join(__dirname, "..", "..", "dist", "src", "index.html"));
    }
  ...
  async createHistoryWindow() {
    ...
    if (isDev) {
      ...
      await this.historyWindow.loadFile(
        path.join(__dirname, "..", "..", "dist", "src", "history.html")
      );
    }
  ...
  async createSettingsWindow() {
    ...
    if (isDev) {
      ...
      await this.settingsWindow.loadFile(
        path.join(__dirname, "..", "..", "dist", "src", "settings.html")
      );
    }
